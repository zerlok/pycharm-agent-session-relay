...
/**
 * The seam between the application and presentation layers (ARCHITECTURE.md — "Layers"): a
 * `MessageBus` topic the view subscribes to. The view never holds a storage handle — it reacts to
 * these events and re-queries [ReviewBatchService]. Callbacks fire on the EDT.
 *
...
interface ReviewBatchListener {
     ...
     * live marker's current line range at a sync point. Surfaces reconcile by diff and refresh what
     * they show for this id; the live marker stays the source of truth.
     */
